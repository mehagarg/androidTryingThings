...
public class RadialProgressIndicator extends View {
     ...
     * duration decreases. If the application has registered a {@link com.example.coffeshop.visualizer.widgets.RadialProgressIndicator.TimerListener}, then
     * upon reaching the timeout value, {@link com.example.coffeshop.visualizer.widgets.RadialProgressIndicator.TimerListener#onTimeout()} will be called.<br/>
...
//    private int[] colors = new int[] { Color.argb(0x10, 0xFF, 0xFF, 0xFF), Color.WHITE, Color.WHITE };
     ...
     * {@link com.example.coffeshop.visualizer.widgets.RadialProgressIndicator.TimerListener#onTimeout()}
